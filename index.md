...
function. This returns taxonomic and geographic information for the
occurrences that is required by these functions.
...
the function
[`pbdb_occurrences()`](https://docs.ropensci.org/paleobioDB/reference/pbdb_occurrences.md),
check out the synonyms and errors that could appear in `accepted_name`,
`genus`, etc. If they are not corrected or eliminated, they will
increase the richness of genera.
...
![](reference/figures/README-pbdb_map-1.png)
...
![](reference/figures/README-pbdb_map_occur-1.png)
...
genera, family, etc. per cell. As with
[`pbdb_map_occur()`](https://docs.ropensci.org/paleobioDB/reference/pbdb_map_occur.md),
...
![](reference/figures/README-pbdb_map_richness-1.png)
...
![](reference/figures/README-pbdb_temp_range-1.png)
...
![](reference/figures/README-pbdb_richness-1.png)
...
plot. `orig_ext = 1` plots new appearances:
...
![](reference/figures/README-pbdb_orig_ext_1-1.png)
...
![](reference/figures/README-pbdb_orig_ext_2-1.png)
...
![](reference/figures/README-pbdb_subtaxa-1.png)
...
![](reference/figures/README-pbdb_temporal_resolution-1.png)
